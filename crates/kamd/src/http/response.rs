...
use kam_kiro::{KiroEvent, UsageInfo};
...
impl DecodedResponse {
    ...
    pub fn claude_json(
        ...
        if !self.reasoning.is_empty() {
            content.push(json!({
                ...
                "signature":kam_translate::SIGNATURE_PLACEHOLDER
            }));
        }
    ...
    pub fn openai_json(
        ...
        max_tokens: u32,
        current_round_output_tokens: u64,
        thinking_format: kam_core::config::ThinkingOutputFormat,
        ...
        let content = match thinking_format {
            kam_core::config::ThinkingOutputFormat::Claude if !self.reasoning.is_empty() => {
        ...
        let reasoning_content = match thinking_format {
            kam_core::config::ThinkingOutputFormat::Openai if !self.reasoning.is_empty() => {
                json!(self.reasoning)
            }
            _ => Value::Null,
        };
...
mod tests {
    ...
    fn response_format_and_stop_reason_use_config_and_current_round() {
        ...
        let tagged = decoded.openai_json(
            ...
            50,
            10,
            kam_core::config::ThinkingOutputFormat::Claude,
        ...
        let openai = decoded.openai_json(
            ...
            50,
            10,
            kam_core::config::ThinkingOutputFormat::Openai,
            &std::collections::HashMap::new(),
        );
        assert_eq!(
